    ...
    <div className="play-video">
      ...
      <div className="vid-description">
        ...
        <div className="comment">
          ...
          <div>
            <h3>
              Jack Nicholson <span>1 day</span>
            </h3>
            <p>
              Great explanation bro 🔥 This video helped me understand React
              routing much better.The way you explained components and
              navigation was very simple and beginner friendly.Waiting for the
              next tutorial 🚀
            </p>
